...
const PostCard = ({ post, className }: PostCardProps) => {
        ...
        return (
            <Link to={`/post/${post.id}#comments`}>
                <button
                    ...
                    className="font-family-sans font-medium text-[16px] text-nowrap text-text-base bg-background-base hover:bg-background-950">
    ...
    if (screenSize === ScreenSize.Mobile) { /* Mobile Layout */
        return (
            <div className={twMerge("bg-background-base p-4 border-1 border-text-600 rounded-3xl", className)}>
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-col gap-2.5 basis-[92%] ml-3">
                        ...
                        <div className="flex flex-row flex-wrap gap-2.5 justify-between ">
                            <CommentsButton />
                            <ViewPostButton />
                        </div>
                    </div>
